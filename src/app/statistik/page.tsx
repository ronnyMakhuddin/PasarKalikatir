    ...
    <div className="container mx-auto px-4 py-4 md:py-8">
      ...
      <div className="text-center mb-8 md:mb-12">
        ...
        <p className="text-base md:text-lg text-foreground/80 max-w-3xl mx-auto px-4 mb-4">
          Lihat perkembangan dan performa platform Pasar Kalikatir secara detail.
        </p>
        <p className="text-sm md:text-base text-foreground/60 max-w-2xl mx-auto px-4">
          Analisis komprehensif untuk memahami pertumbuhan ekonomi digital desa.
        </p>
      </div>
      ...
      <Suspense fallback={
        ...
        <DetailedStats products={products} />
      </Suspense>
    </div>
  );
} 